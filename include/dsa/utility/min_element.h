...
/**
 * @brief Returns the index of the minimum element in a generic array.
 *
 * This function finds the index of the minimum element in an array using
 * a user-provided comparison function. If multiple elements are equal to
 * the minimum, the index of the first one is returned.
 *
 ...
 *
 * @note If there are multiple elements equal to the minimum, the first such
