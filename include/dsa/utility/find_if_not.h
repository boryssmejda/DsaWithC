...
/**
 * @brief Find the index of the first element in an array that does not match a predicate.
 *
 ...
 * @return Index of the first non-matching element in the range [0, count), or count if all match or input is invalid.
 *
...
/**
 * @brief Find the index of the first element in an array that does not match a predicate with context.
 *
